...
namespace Byzantium1071.Campaign.UI
{
    ...
    public sealed class B1071_MapBarVMMixin : BaseViewModelMixin<MapBarVM>
    {
        ...
        private string _tabNearbyText = new TaleWorlds.Localization.TextObject("{=b1071_tab_nearby}Nearby").ToString();
        private string _tabCastlesText = new TaleWorlds.Localization.TextObject("{=b1071_tab_castles}Castles").ToString();
        private string _tabTownsText = new TaleWorlds.Localization.TextObject("{=b1071_tab_towns}Towns").ToString();
        private string _tabFactionsText = new TaleWorlds.Localization.TextObject("{=b1071_tab_factions}Factions").ToString();
        private string _tabVillagesText = new TaleWorlds.Localization.TextObject("{=b1071_tab_villages}Villages").ToString();
        private string _tabArmiesText = new TaleWorlds.Localization.TextObject("{=b1071_tab_armies}Armies").ToString();
        private string _tabWarsText = new TaleWorlds.Localization.TextObject("{=b1071_tab_wars}Wars").ToString();
        private string _tabRebellionText = new TaleWorlds.Localization.TextObject("{=b1071_tab_rebellion}Rebellion").ToString();
        private string _tabPrisonersText = new TaleWorlds.Localization.TextObject("{=b1071_tab_prisoners}Prisoners").ToString();
        ...
        public B1071_MapBarVMMixin(MapBarVM vm) : base(vm)
        {
            ...
            B1071_OverlayController._forceSyncCallback = () => SyncFromController(notifyAll: true);
        }
        ...
        [DataSourceProperty]
        public int B1071PanelTopOffset
        {
            get => _panelTopOffset;
        ...
        [DataSourceProperty]
        public string B1071TabCharactersText
        {
            get => _tabCharactersText;
            set => SetField(ref _tabCharactersText, value, nameof(B1071TabCharactersText));
        }

        [DataSourceProperty]
        public bool B1071TabCharactersSelected
        {
            get => _tabCharactersSelected;
            set => SetField(ref _tabCharactersSelected, value, nameof(B1071TabCharactersSelected));
        }

        [DataSourceProperty]
        public string B1071TabSearchText
        {
            get => _tabSearchText;
            set => SetField(ref _tabSearchText, value, nameof(B1071TabSearchText));
        }
        ...
        [DataSourceProperty]
        public bool B1071SearchControlsVisible
        {
            get => _searchControlsVisible;
            set => SetField(ref _searchControlsVisible, value, nameof(B1071SearchControlsVisible));
        }

        [DataSourceProperty]
        public string B1071SearchQuery
        {
            get => _searchQuery;
            set
            {
                if (string.Equals(_searchQuery, value, System.StringComparison.Ordinal))
                    return;

                SetField(ref _searchQuery, value, nameof(B1071SearchQuery));
        ...
        [DataSourceMethod]
        public void ExecuteB1071TabCharacters()
        {
        ...
        [DataSourceMethod]
        public void ExecuteB1071TabSearch()
        {
            B1071_OverlayController.SetLedgerTab(B1071LedgerTab.Search);
            RefreshLedgerBindings();
        }
