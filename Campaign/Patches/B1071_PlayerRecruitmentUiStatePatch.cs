...
// "RefreshPartyProperties" is still private in v1.4.7.
// Verified against v1.4.7 TaleWorlds.CampaignSystem.ViewModelCollection.dll (signature unchanged). Re-verify after game updates.
