...
namespace Byzantium1071.Campaign.Patches
{
    ...
    /// returns ExplainedNumber — Postfix modifies via ref __result. v1.4.8 (unchanged since v1.3.15).
    /// </summary>
    ...
    public static class B1071_GovernanceSecurityPatch
    {
        ...
        public static void Postfix(Town town, ref ExplainedNumber __result)
        {
            try
            {
                ...
                float recovery = B1071_GovernanceStabilizationBehavior.Instance?.GetActiveSecurityBonus(town) ?? 0f;
                if (recovery > 0f)
